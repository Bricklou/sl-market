...
|
*/
Encore.addEntry('app', './resources/app/index.tsx')
...
Encore.enableTypeScriptLoader((tsconfig) => {
  tsconfig.context = join(__dirname, './resources/app')
  tsconfig.configFile = join(__dirname, './resources/app/tsconfig.json')
}).enableForkedTypeScriptTypesChecking((config) => {
  config.typescript = {
    context: join(__dirname, './resources/app'),
    configFile: join(__dirname, './resources/app/tsconfig.json'),
  }
})
...
Encore.addPlugin(
  new ESLintPlugin({
    ...
    files: join(__dirname, './resources/app/**/*.{ts,tsx,js,jsx}'),
    fix: true,
    threads: true,
  })
)
...
Encore.addAliases({
  ...
  '@c': join(__dirname, 'resources/app/components'),
  '@v': join(__dirname, 'resources/app/views'),
})
